...
public class Admin_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Project TANGEDCO - Admin Login");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(jTextField1.getText().equalsIgnoreCase("admin") && new String(jPasswordField1.getPassword()).equalsIgnoreCase("admin1234"))
        {
            dispose();
            new Admin_Home().show();
        }
