...
public class Add_Employee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Project TANGEDCO - Add Employee");
        ...
        jLabel1.setText("Project TANGEDCO - Add an Employee");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if(flag){
            ...
            if( a > 0){
                  ...
                  JOptionPane.showMessageDialog(null, "Unfortunately, employee details could not be added. Please recheck all the fields.");
            }
   ...
   public int addEmployee()
	...
	try{
		String query="insert into employee(ename,email,phoneno,city,specialization) values('"+
                        jTextField1.getText()+"','"+
                        jTextField2.getText()+"',"+
                        jTextField3.getText()+",'"+
                        city +"','"+
