...
public class Update_Complaint extends javax.swing.JFrame {
    ...
    public Update_Complaint() {
     ...
     public Update_Complaint(String e) {
        eid = e;
        initComponents();
        populateServiceNo();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Project TANGEDCO - Update Complaint");
        ...
        jLabel1.setText("Project TANGEDCO - Update Complaint");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pending", "Resolved" }));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
       ...
       int a =  updateComplaint();
       if( a > 0){
                  JOptionPane.showMessageDialog(null, "Complaint updated successfully...");
            }
       else{
                  JOptionPane.showMessageDialog(null, "Unfortunately, complaint could not be updated.");
        }
   ...
   public void populateServiceNo(){
	...
	try{
                ...
                String query = "update complaint set status = '"+
                         st + "' where serviceno = '"+sno+"';";
